...
const MenuWithOverlay = () => {
  ...
  /**
   * ✏️ TODO STEP 1: Uncomment the call to usePopup hook to configure a popup overlay.
  ...
  return (
    <div style={{ padding: "50px" }}>
      ...
      {/**
       * ✏️ TODO STEP 2: Connect the FilterTrigger button to the popup controls.
      ...
      {/**
       * ✏️ TODO STEP 3: Wrap MenuList with PopupOverlay component.
